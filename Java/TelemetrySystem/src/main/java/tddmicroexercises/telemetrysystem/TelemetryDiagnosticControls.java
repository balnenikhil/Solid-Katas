...
public class TelemetryDiagnosticControls implements DiagnosticControls
{
    ...
    private ConnectionService telemetryConnectionService;
    private String diagnosticInfo = "";

    public TelemetryDiagnosticControls(TransmissionService telemetryTransmissionService, ConnectionService telemetryConnectionService) {
